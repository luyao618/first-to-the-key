...
| 6 | Fog of War / Vision | Gameplay | MVP | Approved | [fog-of-war.md](fog-of-war.md) | Maze Data Model, Grid Movement (mover_moved signal) |
...
6. **Fog of War / Vision** — depends on: Maze Data Model, Grid Movement (mover_moved signal)
